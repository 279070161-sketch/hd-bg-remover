...
async function main() {
  const baseUrl = 'https://hf-mirror.com/briaai/RMBG-1.4/raw/main';
  const lfsUrl = 'https://hf-mirror.com/briaai/RMBG-1.4/resolve/main';
  ...
  try {
    ...
    await downloadFile(`${lfsUrl}/onnx/model.onnx`, path.join(ONNX_DIR, 'model.onnx'));
    console.log('🎉 BRIA RMBG-1.4 SOTA MODEL DOWNLOADED LOCALLY TO public/models/briaai-rmbg-1.4!');
  } catch (err) {
